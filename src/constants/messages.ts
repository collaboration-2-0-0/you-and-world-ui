export const MessagesMap = {
  ...
  MEMBER_INVITE_CREATE_WAITING: 'Лінк-запрошення надіслано користувачу в чат',
  ...
  MEMBER_INVITE_COPY_FAIL: 'Не вдалося скопіювати запрошення',
